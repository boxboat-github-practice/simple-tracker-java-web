...
public class ContractPatch {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContractPatch is not found in the empty JSON string", ContractPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ContractPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContractPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContractPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContractPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContractPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContractPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<ContractPatch>() {
           @Override
           public void write(JsonWriter out, ContractPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContractPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ContractPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContractPatch
  * @throws IOException if the JSON string is invalid with respect to ContractPatch
  */
  public static ContractPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContractPatch.class);
  }

 /**
  * Convert an instance of ContractPatch to an JSON string
  *
  * @return JSON string
  */
